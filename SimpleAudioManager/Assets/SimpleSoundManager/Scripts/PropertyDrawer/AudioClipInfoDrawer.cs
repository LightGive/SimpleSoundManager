...
public class AudioClipInfoDrawer : PropertyDrawer
{
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		using (new EditorGUI.PropertyScope(position, label, property))
		{
			...
			EditorGUI.ObjectField(audioClipRect, "", audioClipProp.objectReferenceValue, typeof(AudioClip), false);
			var t = ((AudioClip)audioClipProp.objectReferenceValue).length;
			...
			{
				if ((AudioClip)audioClipProp.objectReferenceValue == null)
				{
				...
				StopAllClips();
				PlayClip((AudioClip)audioClipProp.objectReferenceValue);
			}
		}
	}
